...
|----------|---------------|-------|
| 🍎 **macOS Intel** | [Download DMG](https://github.com/your-username/uap-invaders/releases/latest/download/UAP.Invaders.Contact.Protocol-1.0.0.dmg) | ~96 MB |
| 🍎 **macOS ARM** | [Download DMG](https://github.com/your-username/uap-invaders/releases/latest/download/UAP.Invaders.Contact.Protocol-1.0.0-arm64.dmg) | ~90 MB |
| 🪟 **Windows** | [Download EXE](https://github.com/your-username/uap-invaders/releases/latest/download/UAP.Invaders.Contact.Protocol.Setup.1.0.0.exe) | ~146 MB |
| 🐧 **Linux** | [Download AppImage](https://github.com/your-username/uap-invaders/releases/latest/download/UAP.Invaders.Contact.Protocol-1.0.0.AppImage) | ~99 MB |

### Web Version (Instant Play)
No download required! Play in your browser:
👉 https://your-username.github.io/uap-invaders/
